...
public class MCostDetail extends X_M_CostDetail
{
	 ...
	 */
	public boolean isBoulderReceipt()
	{
		return getTF_Boulder_Receipt_ID() != 0;
	}	//	isInvoice

	// SyvaSoft
	public int getTF_Boulder_Receipt_ID() {
		return get_ValueAsInt("TF_Boulder_Receipt_ID");
	}
	
	/** By SyvaSoft..
	 * 	Create New Boulder Receipt Cost Detail.
