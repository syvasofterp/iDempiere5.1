...
public class WSExportProcessor implements IExportProcessor {
	...
	public void process(Properties ctx, MEXPProcessor expProcessor, Document document, Trx trx) throws Exception {
        ...
        //save into export queue
        MExportQueue expQ = new MExportQueue(ctx, 0, trx.getTrxName());
        expQ.setMsgText(writer.toString());
        expQ.saveEx();
